...
namespace Tizen.FH.FamilyBoard
{
    public class BackgroundImageChooser : ILifecycleObserver
    {
        ...
        private FlexibleView.ViewHolder mLastCheckedBackgroundImage;
        ...
        public void ChooseBackgroundImage(int position, string style)
        {
            ...
            FamilyBoardApplication.Instance.ChangeMainBackground();
        }

        public void SetLastCheckedBackgroundImage(FlexibleView.ViewHolder vh)
        {
        ...
        private void CreateBackgroundImageGrid()
        {
            ...
            mBackgourndImageGrid.ItemClickEvent += OnGridItemClickEvent;
            ...
            GridLayoutManager layoutManager = new GridLayoutManager(4, LinearLayoutManager.Orientation.VERTICAL);
    ...
    internal class BackgroundImageGridBridge : FlexibleView.Adapter
    {
