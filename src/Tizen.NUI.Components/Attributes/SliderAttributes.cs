...
namespace Tizen.NUI.Components
{
    ...
    public class SliderStyle : ControlStyle
    {
        ...
        public SliderStyle() : base()
        {
            ...
            //BackgroundTrackAttributes = new ImageViewAttributes();
            //SlidedTrackAttributes = new ImageViewAttributes();
            //ThumbImageAttributes = new ImageViewAttributes();
            //ThumbBackgroundAttributes = new ImageViewAttributes();
            //LowIndicatorImageAttributes = new ImageViewAttributes();
            //HighIndicatorImageAttributes = new ImageViewAttributes();
            //LowIndicatorTextAttributes = new TextLabelAttributes();
            //HighIndicatorTextAttributes = new TextLabelAttributes();
            InitSubStyle();
        }
